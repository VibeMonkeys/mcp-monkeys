...
class CalendarIntegrationTest {
    ...
    fun `mcp endpoint should return server info`() {
        ...
        assertTrue(mcpJson.get("name").asText().contains("calendar"))
    ...
    fun `should provide calendar specific mcp capabilities`() {
        ...
        assertTrue(mcpJson.get("description").asText().contains("Calendar"))
        assertTrue(mcpJson.get("capabilities").get("tool").asBoolean())
        assertTrue(mcpJson.get("type").asText() == "SYNC")
    }
}